...
```
It is found that logical and factor vector could be converted into numeric value, while the character vector could not. It can explain why logical vetor can take the mean, but cannot help to explain why factor vector cannot.
...
The proportion of cases for which x + y > 1 is 'r prop.table(vec_logic_1)'.
